...
class MidiPro {
  ...
  /// Applies a uniform pitch offset, in cents, to every note played through the
  /// soundfont. Pass 0 for standard A=440 tuning; pass ~-31.77 for A=432.
  Future<void> setGlobalTuning({required double cents, int sfId = 1}) async {
    return FlutterMidiProPlatform.instance.setGlobalTuning(sfId, cents);
  }
