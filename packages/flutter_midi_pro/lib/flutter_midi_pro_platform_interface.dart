...
abstract class FlutterMidiProPlatform extends PlatformInterface {
  ...
  /// soundfont. Zero restores standard A=440 tuning.
  Future<void> setGlobalTuning(int sfId, double cents) {
    throw UnimplementedError('setGlobalTuning() has not been implemented.');
  }
